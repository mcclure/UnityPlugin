...
function lovr.errhand(message)
  ...
  while true do
    lovr.event.pump()
    local dt = (lovr.headset and lovr.headset.isPresent()) and .001 or .1
...
if not lovr.filesystem.getSource() or not runnable then
  ...
  function lovr.load()
    print("Loaded default lovr program-- no script loaded" .. (arg and arg[1] and (" at " .. arg[1]) or ""))
--[[
